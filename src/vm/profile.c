...
/* Opcode names for profile dump. Index = jello_op value. */
static const char* const op_names[JOP_COUNT] = {
  ...
  [JOP_BYTES_BITAND2] = "bytes_bitand2",
  [JOP_BYTES_BITOR2] = "bytes_bitor2",
  [JOP_BYTES_BITXOR2] = "bytes_bitxor2",
  [JOP_JMP] = "jmp",
  [JOP_JMP_IF] = "jmp_if",
  [JOP_TRY] = "try",
  [JOP_ENDTRY] = "endtry",
  ...
  [JOP_SHR_I32] = "shr_i32",
  [JOP_SHR_I64] = "shr_i64",
  [JOP_BITAND_I32] = "bitand_i32",
  [JOP_BITAND_I64] = "bitand_i64",
  [JOP_BITOR_I32] = "bitor_i32",
  [JOP_BITOR_I64] = "bitor_i64",
  [JOP_BITXOR_I32] = "bitxor_i32",
  [JOP_BITXOR_I64] = "bitxor_i64",
  [JOP_ADD_F16] = "add_f16",
  [JOP_SUB_F16] = "sub_f16",
  [JOP_MUL_F16] = "mul_f16",
  [JOP_ADD_F32] = "add_f32",
  ...
  [JOP_OBJ_SET] = "obj_set",
  [JOP_OBJ_HAS] = "obj_has",
  [JOP_OBJ_REMOVE] = "obj_remove",
  [JOP_OBJ_CLEAR] = "obj_clear",
  [JOP_OBJ_COPY] = "obj_copy",
  [JOP_OBJ_KEYS] = "obj_keys",
  [JOP_ARRAY_CONCAT2] = "array_concat2",
  [JOP_ARRAY_RESIZE] = "array_resize",
  [JOP_ENUM_NEW] = "enum_new",
  [JOP_ENUM_TAG] = "enum_tag",
  [JOP_ENUM_GET] = "enum_get",
  [JOP_LT_I64] = "lt_i64",
  [JOP_LT_F32] = "lt_f32",
  [JOP_LT_F64] = "lt_f64",
...
void jello_vm_profile_dump(const jello_vm* vm, FILE* out) {
  ...
  fprintf(out, "JELLO_PROFILE opcodes (total=%" PRIu64 "):\n", total);
  ...
  if(calls_total > 0 || stack_alloc > 0) {
    fprintf(out, "JELLO_PROFILE calls/frames:\n");
